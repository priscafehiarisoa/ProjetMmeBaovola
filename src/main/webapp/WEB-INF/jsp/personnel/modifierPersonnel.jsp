...
<% List<TypeMainOeuvre> typeMainOeuvres=new ArrayList<>();
  ...
  if(request.getAttribute("modifPersonnle")!=null){
    personnel= (Personnel) request.getAttribute("modifPersonnle");
  }
%>
    ...
    <div class="card-body">
      ...
      <form action="${pageContext.request.contextPath}/newPersonnel" method="post">
        <div class="form-group">
          ...
          <input type="text" name="Nom" class="form-control " value="<%=personnel.getNomPersonnel()%>">
          <input type="hidden" name="id" class="form-control " value="<%=personnel.getId()%>">
          <br>
        </div>

        <div class="form-group">
          <label for="">date d'embauche </label>
          <input type="date" name="dateEmbauche" class="form-control " value="<%=personnel.getDateEmbauche()%>">
        </div>

        <div class="form-group">
          <label for="">Type de poste </label>
          <select name="typeMainOeuvre" id="" class="form-control" value=<%=personnel.getTypeMainOeuvre().getId()%>>
